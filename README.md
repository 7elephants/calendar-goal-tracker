...
- Pass/Fail goals also show a **🔥 N-day streak** in the Goal summary — the
...
- [ ] Mark a Pass/Fail goal done for 3 consecutive days ending today; confirm the Goal summary shows "🔥 3-day streak".
- [ ] Mark that same goal failed today; confirm the streak immediately drops to "🔥 0-day streak".
- [ ] Build a 3-day streak ending yesterday, then reopen the add-on without marking anything for today; confirm the streak still shows "🔥 3-day streak" (today pending doesn't break it yet).
- [ ] From that same pending state, mark today done; confirm the streak becomes "🔥 4-day streak". Alternatively mark it failed; confirm it becomes "🔥 0-day streak".
